...
app = dash.Dash(
    ...
    suppress_callback_exceptions=True,  # to suppress at the beginning
    use_pages=True,
    pages_folder="pages",
...
# combine content with sidebar (every page will have the sidebar, but a different content)
app.layout = html.Div(
    id="main-layout",
    children=[
        sidebar,
...
# Callback to toggle sidebar collapse (interactive)
@app.callback(
